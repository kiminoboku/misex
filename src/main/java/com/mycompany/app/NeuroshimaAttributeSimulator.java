...
public class NeuroshimaAttributeSimulator {
	...
	public List<Integer> roll() {
		 ...
		 * //highest5RollResults.replaceAll(operator); } else if
		 * (highest5RollResults.get(1) < 6) { highest5RollResults.remove(1);
		 * highest5RollResults.add(6); } else if (highest5RollResults.get(2) < 6) {
		 * highest5RollResults.remove(2); highest5RollResults.add(6); } else if
		 * (highest5RollResults.get(3) < 6) { highest5RollResults.remove(3);
		 * highest5RollResults.add(6); } else (highest5RollResults.get(4) < 6) {
		 * highest5RollResults.remove(4); highest5RollResults.add(6); }
		 */
		Collections.sort(highest5RollResults);
